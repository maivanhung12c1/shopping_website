...
from store.models import (
    CartOrderItem, CouponUsers, Notification, Product, Tag, Category, Cart, DeliveryCouriers, CartOrder, Gallery, Brand, ProductFaq, Review,
    Specification, Coupon, Color, Size, Address, Wishlist
)
...
class ProductAdmin(ImportExportModelAdmin):
    ...
    list_display = [
        'product_image', 'image', 'title', 'price', 'featured', 'shipping_amount', 'in_stock', 'stock_qty', 'order_count', 'vendor', 'featured',
        'special_offer', 'hot_deal', 'status'
        ]
    actions = [make_featured, make_in_review, make_published]
    list_per_page = 100
...
class CartAdmin(ImportExportModelAdmin):
    list_display = [
        'product', 'cart_id', 'qty', 'price', 'sub_total', 'shipping_amount', 'service_fee', 'tax_fee', 'total', 'country', 'size', 'color', 'date'
        ]
...
class CartOrderItemsAdmin(ImportExportModelAdmin):
    ...
    list_editable = ['date']
    list_display = [
        'order_id', 'vendor', 'product', 'qty', 'price', 'sub_total', 'shipping_amount', 'service_fee', 'tax_fee', 'total',
        'delivery_couriers', 'applied_coupon', 'date'
        ]
