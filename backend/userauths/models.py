...
class Profile(models.Model):
    ...
    image = models.FileField(upload_to="accounts/users", default="default/default-user.jpg", null=True, blank=True)
    ...
    pid = ShortUUIDField(unique=True, max_length=20, length=20, alphabet="abcdefghijklmnopqrstuvxyz")
