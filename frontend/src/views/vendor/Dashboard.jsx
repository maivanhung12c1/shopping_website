...
function Dashboard() {
    ...
    console.log(`userData?.vendor_id ${userData?.vendor_id}`)
    ...
    useEffect(() => {
        const fetchChartData = async () => {
            try {
                const orderResponse = await axios.get(`vendor-orders-report-chart/${userData?.vendor_id}/`);
                setOrderChartData(orderResponse.data);

                const productResponse = await axios.get(`vendor-products-report-chart/${userData?.vendor_id}/`);
                ...
                <div className="col-lg-6 ">
                  <div className="card">
                    <div className="card-body" >
                      <Line data={orderData} style={{ height: 300, minWidth: "630px" }} />
                    </div>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="card">
                    <div className="card-body" >
                      <Line data={productData} style={{ height: 300, minWidth: "630px" }} />
                    </div>
                  </div>
                </div>
              </div>
